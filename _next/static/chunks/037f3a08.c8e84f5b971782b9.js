...
`)}get variablesInfo(){if(0!==this.uniforms.length)return this.uniforms.map(e=>[[12,10,1,6][["u32","f16","f32","i32"].indexOf(e.type)],e.length??1])}},tP=(e,r)=>new tU(e,r)}),nN=W(()=>{nT(),nz(),nM(),nD(),tq=(e,r)=>0!==r.length?r:[...Array(e).keys()].reverse(),tL=(e,r)=>{let i=e.dataType,a=e.dims.length,n=tq(a,r),s=((e,r)=>e6.sortBasedOnPerm(e,tq(e.length,r)))(e.dims,n),o=e.dims,u=s;if(a<2||((e,r)=>{let i=0;for(let a=0;a<e.length;++a)if(1!==r[e[a]]){if(e[a]<i)return!1;i=e[a]}return!0})(n,e.dims))return{name:"TransposeCopy",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let r=e6.size(s);return{outputs:[{dims:s,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(r/64/4)},programUniforms:[{type:12,data:Math.ceil(r/4)}]}},getShaderSource:e=>{let r=tB("input",i,o,4),a=tM("output",i,u,4);return`
  ${e.registerUniform("output_size","u32").declareVariables(r,a)}
  ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
    output[global_idx] = input[global_idx];
  }`}};let{newShape:l,newPerm:d}=((e,r)=>{let i=[],a=[];for(let n=0;n<e.length;++n)1!==e[n]&&i.push(e[n]),1!==e[r[n]]&&a.push(r[n]);return{newShape:i,newPerm:a}})(e.dims,n),p=e6.areEqual(d,[2,3,1]),c=e6.areEqual(d,[3,1,2]);return 2===l.length||p||c?(u=[(o=p?[l[0],l[1]*l[2]]:c?[l[0]*l[1],l[2]]:l)[1],o[0]],{name:"TransposeShared",shaderCache:{inputDependencies:["type"]},getRunData:()=>{let r=e6.size(s);return{outputs:[{dims:s,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(u[1]/16),y:Math.ceil(u[0]/16)},programUniforms:[{type:12,data:r},...tI(o,u)]}},getShaderSource:e=>{let r=tB("a",i,o.length),a=tM("output",i,u.length);return`
  ${e.registerUniform("output_size","u32").declareVariables(r,a)}
  ...
  }`}}):{name:"Transpose",shaderCache:{hint:`${r}`,inputDependencies:["rank"]},getRunData:()=>{let r=e6.size(s);return{outputs:[{dims:s,dataType:e.dataType}],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:[{type:12,data:r},...tI(o,u)]}},getShaderSource:e=>{let r=tB("a",i,o.length),s=tM("output",i,u.length);return`
  ...
  ${e.mainStart()}
    ...
    ${s.setByOffset("global_idx",r.getByIndices("aIndices"))}
       ...
       `;return{name:e,shaderCache:{hint:`${r};${h}`,inputDependencies:["type"]},getShaderSource:e=>`
        ...
        }`,getRunData:()=>({outputs:[{dims:s,dataType:n}],dispatchGroup:{x:l},programUniforms:[{type:12,data:d}]})}})(r,n.cacheKey,[l],a,e.inputs[0].dataType,h,c),{inputs:[l]})},tZ=(e,r)=>{tK(e,"ReduceMeanShared",r,"mean")},tQ=(e,r)=>{tK(e,"ReduceL1Shared",r,"l1")},tX=(e,r)=>{tK(e,"ReduceL2Shared",r,"l2")},tY=(e,r)=>{tK(e,"ReduceLogSumExpShared",r,"logSumExp")},tJ=(e,r)=>{tK(e,"ReduceMaxShared",r,"max")},t0=(e,r)=>{tK(e,"ReduceMinShared",r,"min")},t1=(e,r)=>{tK(e,"ReduceProdShared",r,"prod")},t2=(e,r)=>{tK(e,"ReduceSumShared",r,"sum")},t3=(e,r)=>{tK(e,"ReduceSumSquareShared",r,"sumSquare")},t4=(e,r)=>{tK(e,"ReduceLogSumShared",r,"logSum")}}),nP=W(()=>{nT(),nz(),nM(),nD(),nU(),t6=e=>{if(!e||0===e.length||e.length>2)throw Error("Reduce op requires 1 or 2 inputs.");if(2===e.length&&1!==e[1].dims.length)throw Error("Invalid axes input dims.")},t8=e=>["","",`var value = ${e.getByIndices("input_indices")};`,""],t5=(e,r,i,a,n,s,o=!1,u=!1)=>{let l=[],d=i[0].dims,p=d.length,c=e6.normalizeAxes(n,p),h=!u&&0===c.length;d.forEach((e,r)=>{h||c.indexOf(r)>=0?o&&l.push(1):l.push(e)});let f=l.length,m=e6.size(l);return{name:e,shaderCache:r,getShaderSource:e=>{let r=[],n=tB("_A",i[0].dataType,p),u=tM("output",s,f),l=a(n,u,c),m=l[2];for(let e=0,i=0;e<p;e++)h||c.indexOf(e)>=0?(o&&i++,m=`for(var j${e}: u32 = 0; j${e} < ${d[e]}; j${e}++) {
...
`)}
        }`},getRunData:()=>({outputs:[{dims:l,dataType:s}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:[{type:12,data:m},...tI(d,l)]})}},t9=(e,r)=>{let i=[];return e[1].dims[0]>0&&e[1].getBigInt64Array().forEach(e=>i.push(Number(e))),tw({axes:i,keepDims:r.keepDims,noopWithEmptyAxes:r.noopWithEmptyAxes})},t7=(e,r,i,a)=>{let n=e.inputs,s=1===n.length?i:t9(n,i);e.compute(t5(r,{hint:s.cacheKey,inputDependencies:["rank"]},[n[0]],s.noopWithEmptyAxes&&0===s.axes.length?t8:a,s.axes,n[0].dataType,s.keepDims,s.noopWithEmptyAxes),{inputs:[0]})},re=(e,r,i)=>{if(0===r.length)return i;let a=1,n=1;for(let i=0;i<r.length;i++)-1===r.indexOf(i)?a*=e[i]:n*=e[i];return n<32&&a>1024},rt=(e,r)=>{re(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?((e,r)=>{t6(e.inputs),t7(e,"ReduceMean",r,(r,i,a)=>{let n=1;for(let i=0;i<r.rank;i++)(a.indexOf(i)>=0||0===a.length)&&(n*=e.inputs[0].dims[i]);return["var sum = f32(0);","",`sum += f32(${r.getByIndices("input_indices")});`,`let value = ${i.type.value}(sum / ${n});`]})})(e,r):tZ(e,r)},rr=(e,r)=>{re(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?((e,r)=>{t6(e.inputs),t7(e,"ReduceL1",r,(e,r)=>[`var value = ${r.type.storage}(0);`,"",`value += abs(${e.getByIndices("input_indices")});`,""])})(e,r):tQ(e,r)},ri=(e,r)=>{re(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?((e,r)=>{t6(e.inputs),t7(e,"ReduceL2",r,(e,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${e.getByIndices("input_indices")}; value += (t * t);`,"value = sqrt(value);"])})(e,r):tX(e,r)},ra=(e,r)=>{re(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?((e,r)=>{t6(e.inputs),t7(e,"ReduceLogSumExp",r,(e,r)=>[`var value = ${r.type.storage}(0);`,"",`value += exp(${e.getByIndices("input_indices")});`,"value = log(value);"])})(e,r):tY(e,r)},rn=(e,r)=>{re(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?((e,r)=>{t6(e.inputs),t7(e,"ReduceMax",r,(e,r,i)=>{let a=[];for(let r=0;r<e.rank;r++)(i.indexOf(r)>=0||0===i.length)&&a.push(e.indicesSet("input_indices",r,0));return[`${a.join(`
`)}`,`var value = ${e.getByIndices("input_indices")};`,`value = max(value, ${e.getByIndices("input_indices")});`,""]})})(e,r):tJ(e,r)},rs=(e,r)=>{re(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?((e,r)=>{t6(e.inputs),t7(e,"ReduceMin",r,(e,r,i)=>{let a=[];for(let r=0;r<e.rank;r++)(i.indexOf(r)>=0||0===i.length)&&a.push(`input_indices[${r}] = 0;`);return[`${a.join(`
`)}`,`var value = ${e.getByIndices("input_indices")};`,`value = min(value, ${e.getByIndices("input_indices")});`,""]})})(e,r):t0(e,r)},ro=(e,r)=>{re(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?((e,r)=>{t6(e.inputs),t7(e,"ReduceProd",r,(e,r)=>[`var value = ${r.type.storage}(1);`,"",`value *= ${e.getByIndices("input_indices")};`,""])})(e,r):t1(e,r)},ru=(e,r)=>{re(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?((e,r)=>{t6(e.inputs),t7(e,"ReduceSum",r,(e,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${e.getByIndices("input_indices")};`,""])})(e,r):t2(e,r)},rl=(e,r)=>{re(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?((e,r)=>{t6(e.inputs),t7(e,"ReduceSumSquare",r,(e,r)=>[`var t = ${r.type.value}(0); var value = ${r.type.value}(0);`,"",`t = ${e.getByIndices("input_indices")}; value += t * t;`,""])})(e,r):t3(e,r)},rd=(e,r)=>{re(e.inputs[0].dims,r.axes,r.noopWithEmptyAxes)?((e,r)=>{t6(e.inputs),t7(e,"ReduceLogSum",r,(e,r)=>[`var value = ${r.type.storage}(0);`,"",`value += ${e.getByIndices("input_indices")};`,"value = log(value);"])})(e,r):t4(e,r)}}),nq=W(()=>{nT(),nM(),nP(),rp=e=>{if(!e||0===e.length||e.length>2)throw Error("ArgMinMaxOp op requires 1 or 2 inputs.");if(1!==e[0].dataType)throw Error("Invalid input type.")},rc=(e,r)=>{rp(e.inputs),e.compute(t5("ArgMin",{hint:r.cacheKey,inputDependencies:["rank"]},[e.inputs[0]],(e,i,a)=>{let n=[];for(let r=0;r<e.rank;r++)(a.indexOf(r)>=0||0===a.length)&&n.push(`input_indices[${r}] = 0;`);return[`${n.join(`
...
var best_index : i32 = 0;`,`if (${e.getByIndices("input_indices")} ${r.selectLastIndex>0?">=":">"} value) {
         value = ${e.getByIndices("input_indices")};
         best_index = i32(last_index);
       }`,"",i.setByOffset("global_idx","best_index")]},[r.axis],7,r.keepDims),{inputs:[0]})},rf=e=>tw(e)}),nL=W(()=>{nT(),nz(),nR(),nD(),rm=(e,r,i)=>r&&e?`
    ...
    `,rg=(e,r,i,a,n,s,o,u,l,d,p,c)=>{let h=Math.min(e.outputCount,1+ +!!o+ +!!u),f=h>1?o:void 0,m=h>1?u:void 0,g=h>1?d.pastSequenceLength:0,y=g+d.kvSequenceLength,_=l&&e6.size(l.dims)>0?l:void 0,b=[r,i];f&&e6.size(f.dims)>0&&b.push(f),_&&b.push(_),p&&b.push(p),c&&b.push(c);let $=e.compute(((e,r,i,a,n,s,o,u,l)=>{let d=o+s.kvSequenceLength,p=[s.batchSize,s.numHeads,s.sequenceLength,d],c=e>1&&a,h=s.kvNumHeads?s.kvNumHeads:s.numHeads,f=c?[s.batchSize,h,d,s.headSize]:void 0,m=s.nReps?s.nReps:1,g=0===s.scale?1/Math.sqrt(s.headSize):s.scale,y=tE(s.headSize),_=s.headSize/y,b={x:Math.ceil(d/12),y:Math.ceil(s.sequenceLength/12),z:s.batchSize*s.numHeads},$=[{type:12,data:s.sequenceLength},{type:12,data:_},{type:12,data:d},{type:12,data:s.numHeads},{type:12,data:s.headSize},{type:1,data:g},{type:12,data:o},{type:12,data:s.kvSequenceLength},{type:12,data:m}],v=c&&a&&e6.size(a.dims)>0,w=["type","type"];v&&w.push("type"),n&&w.push("type"),u&&w.push("type"),l&&w.push("type");let x=[{dims:p,dataType:r.dataType,gpuDataType:0}];return c&&x.push({dims:f,dataType:r.dataType,gpuDataType:0}),{name:"AttentionProbs",shaderCache:{hint:`${y};${void 0!==n};${void 0!==a};${e}`,inputDependencies:w},getRunData:()=>({outputs:x,dispatchGroup:b,programUniforms:$}),getShaderSource:e=>{let s=tB("q",r.dataType,r.dims,y),o=[s,tB("key",i.dataType,i.dims,y)];if(v){let e=tB("past_key",a.dataType,a.dims,y);o.push(e)}n&&o.push(tB("attention_bias",n.dataType,n.dims));let d=u?tB("seq_lens",u.dataType,u.dims):void 0;d&&o.push(d);let h=l?tB("total_sequence_length_input",l.dataType,l.dims):void 0;h&&o.push(h);let g=tM("output",r.dataType,p),_=[g];c&&_.push(tM("present_key",r.dataType,f,y));let b=tT(1,y);return`
  const TILE_SIZE = 12u;
  ...
  }`}}})(h,r,i,f,_,d,g,p,c),{inputs:b,outputs:h>1?[-1,1]:[-1]})[0];e.compute(((e,r,i,a,n,s,o,u)=>{let l=tE(o?1:s),d=64,p=s/l;p<64&&(d=32);let c=[{type:12,data:r},{type:12,data:i},{type:12,data:a},{type:12,data:n},{type:12,data:p},{type:12,data:Math.ceil(s/l/d)}],h=tS(e.dataType,l),f=tT(1,l),m=["type"];return o&&m.push("type"),u&&m.push("type"),{name:"AttentionProbsSoftmax",shaderCache:{hint:`${d};${h};${l}`,inputDependencies:m},getShaderSource:r=>{let i=tM("x",e.dataType,e.dims,l),a=[i],n=o?tB("seq_lens",o.dataType,o.dims):void 0;n&&a.push(n);let s=u?tB("total_sequence_length_input",u.dataType,u.dims):void 0;s&&a.push(s);let p=tT(e.dataType);return`
  ...
  }`,getRunData:()=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:a?[{type:12,data:l},...tI(s)]:[{type:12,data:l}]})}})(a,s))}}),nV=W(()=>{nz(),nD(),rb=e=>{(e=>{if(3!==e[0].dims.length)throw Error("input should have 3 dimensions");if(![320,640,1280].includes(e[0].dims[2]))throw Error("number of channels should be 320, 640 or 1280");if(1!==e[1].dims.length)throw Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw Error("last dimension of input and bias are not the same")})(e.inputs),e.compute((e=>{let r=e[0].dims,i=e[0].dims[2],a=e6.size(r)/4,n=e[0].dataType,s=tB("input",n,r,4),o=tB("bias",n,[i],4),u=tB("residual",n,r,4),l=tM("output",n,r,4);return{name:"BiasAdd",getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(a/64)}}),getShaderSource:e=>`
  ...
  }`}})(e.inputs))}}),nG=W(()=>{nT(),nz(),nM(),nD(),r$=(e,r,i,a,n,s=e.dataType,o,u)=>{let l=[{type:12,data:Math.ceil(e6.size(e.dims)/4)}];return o&&l.push(...o),{name:r,shaderCache:{hint:n,inputDependencies:["type"]},getShaderSource:r=>((e,r,i,a,n,s,o)=>{let u=Math.ceil(r/4),l="";l="string"==typeof n?`${n}(a)`:n("a");let d=tB("inputData",i,[u],4),p=tM("outputData",a,[u],4),c=[{name:"vec_size",type:"u32"}];return o&&c.push(...o),`
  ...
  }`})(r,e6.size(e.dims),e.dataType,s,i,a,u),getRunData:r=>({outputs:[{dims:e.dims,dataType:s}],dispatchGroup:{x:Math.ceil(e6.size(r[0].dims)/64/4)},programUniforms:l})}},rv=e=>{e.compute(r$(e.inputs[0],"Abs","abs"))},rw=e=>{e.compute(r$(e.inputs[0],"Acos","acos"))},rx=e=>{e.compute(r$(e.inputs[0],"Acosh","acosh"))},rk=e=>{e.compute(r$(e.inputs[0],"Asin","asin"))},rS=e=>{e.compute(r$(e.inputs[0],"Asinh","asinh"))},rT=e=>{e.compute(r$(e.inputs[0],"Atan","atan"))},rI=e=>{e.compute(r$(e.inputs[0],"Atanh","atanh"))},rE=e=>tw(e),rz=(e,r)=>{let i;switch(r.to){case 10:i="vec4<f16>";break;case 1:i="vec4<f32>";break;case 12:i="vec4<u32>";break;case 6:i="vec4<i32>";break;case 9:i="vec4<bool>";break;default:throw RangeError(`not supported type (specified in attribute 'to' from 'Cast' operator): ${r.to}`)}e.compute(r$(e.inputs[0],"Cast",i,void 0,r.cacheKey,r.to))},rC=(e,r)=>{let i=r||(e=>{let r,i,a=e.length>=2&&0!==e[1].data,n=e.length>=3&&0!==e[2].data;switch(e[0].dataType){case 1:r=a?e[1].getFloat32Array()[0]:-34028234663852886e22,i=n?e[2].getFloat32Array()[0]:34028234663852886e22;break;case 10:r=a?e[1].getUint16Array()[0]:64511,i=n?e[2].getUint16Array()[0]:31743;break;default:throw Error("Unsupport data type")}return tw({min:r,max:i})})(e.inputs),a=tT(e.inputs[0].dataType);e.compute(r$(e.inputs[0],"Clip",e=>`clamp(${e}, vec4<${a}>(uniforms.min), vec4<${a}>(uniforms.max))`,void 0,i.cacheKey,void 0,[{type:e.inputs[0].dataType,data:i.min},{type:e.inputs[0].dataType,data:i.max}],[{name:"min",type:a},{name:"max",type:a}]),{inputs:[0]})},rA=e=>{e.compute(r$(e.inputs[0],"Ceil","ceil"))},rO=e=>{e.compute(r$(e.inputs[0],"Cos","cos"))},rR=e=>{e.compute(r$(e.inputs[0],"Cosh","cosh"))},rB=e=>tw(e),rM=(e,r)=>{let i=tT(e.inputs[0].dataType);e.compute(r$(e.inputs[0],"Elu",e=>`elu_vf32(${e})`,`
...
}`,rN=e=>{let r=tT(e.inputs[0].dataType);e.compute(r$(e.inputs[0],"Erf",e=>`erf_vf32(${e})`,rD(r)))},rU=e=>{e.compute(r$(e.inputs[0],"Exp","exp"))},rP=e=>{e.compute(r$(e.inputs[0],"Floor","floor"))},rq=e=>{let r=tT(e.inputs[0].dataType);e.compute(r$(e.inputs[0],"Gelu",e=>`0.5 * ${e} * (1.0 + erf_vf32(${e} * 0.7071067811865475))`,rD(r)))},rL=(e,r)=>{let i=tT(e.inputs[0].dataType);e.compute(r$(e.inputs[0],"LeakyRelu",e=>`select(leaky_relu_alpha_ * ${e}, ${e}, ${e} >= vec4<${i}>(0.0))`,`const leaky_relu_alpha_ = ${i}(${r.alpha});`,r.cacheKey))},rW=e=>{e.compute(r$(e.inputs[0],"Not",e=>`!${e}`))},rV=e=>{e.compute(r$(e.inputs[0],"Neg",e=>`-${e}`))},rG=e=>{e.compute(r$(e.inputs[0],"Reciprocal",e=>`1.0/${e}`))},rH=e=>{let r=tT(e.inputs[0].dataType);e.compute(r$(e.inputs[0],"Relu",e=>`select(vec4<${r}>(0.0), ${e}, ${e} > vec4<${r}>(0.0))`))},rF=e=>{e.compute(r$(e.inputs[0],"Sigmoid",e=>`(1.0 / (1.0 + exp(-${e})))`))},rj=e=>tw(e),rK=(e,r)=>{let i=tT(e.inputs[0].dataType);e.compute(r$(e.inputs[0],"HardSigmoid",e=>`max(vec4<${i}>(0.0), min(vec4<${i}>(1.0), ${r.alpha} * ${e} + vec4<${i}>(${r.beta})))`,void 0,r.cacheKey))},rZ=e=>{let r=tT(e.inputs[0].dataType);e.compute(r$(e.inputs[0],"HardSwish",e=>`${e} * max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), vec4<${r}>(${r}(1.0 / 6.0)) * ${e} + vec4<${r}>(0.5)))`))},rQ=e=>{e.compute(r$(e.inputs[0],"Sin","sin"))},rX=e=>{e.compute(r$(e.inputs[0],"Sinh","sinh"))},rY=e=>{e.compute(r$(e.inputs[0],"Sqrt","sqrt"))},rJ=e=>{e.compute(r$(e.inputs[0],"Tan","tan"))},r0=e=>`sign(${e}) * (1 - exp(-2 * abs(${e}))) / (1 + exp(-2 * abs(${e})))`,r1=e=>{e.compute(r$(e.inputs[0],"Tanh",r0))},r2=(e="f32")=>`
...
`,r3=e=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e} * (fast_gelu_c * ${e} * ${e} + fast_gelu_b))) * ${e}`,r4=e=>{let r=tT(e.inputs[0].dataType);e.compute(r$(e.inputs[0],"FastGelu",r3,r2(r),void 0,e.inputs[0].dataType))},r6=(e,r)=>{let i=tT(e.inputs[0].dataType);return e.compute(r$(e.inputs[0],"ThresholdedRelu",e=>`select(vec4<${i}>(0.0), ${e}, ${e} > thresholded_relu_alpha_)`,`const thresholded_relu_alpha_ = vec4<${i}>(${r.alpha});`,r.cacheKey)),0},r8=e=>{e.compute(r$(e.inputs[0],"Log","log"))},r5=e=>`quick_gelu_impl(${e})`,r9=(e,r)=>{let i=tT(e.inputs[0].dataType);e.compute(r$(e.inputs[0],"QuickGelu",r5,((e,r)=>`
...
`)(i,r.alpha),r.cacheKey,e.inputs[0].dataType))}}),nH=W(()=>{nz(),nD(),nG(),r7=e=>{(e=>{if(3!==e[0].dims.length)throw Error("input should have 3 dimensions");if(![2560,5120,10240].includes(e[0].dims[2]))throw Error("hidden state should be 2560, 5120 or 10240");if(1!==e[1].dims.length)throw Error("bias is expected to have 1 dimensions");if(e[0].dims[2]!==e[1].dims[0])throw Error("last dimension of input and bias are not the same")})(e.inputs),e.compute((e=>{let r=e[0].dims.slice();r[2]=r[2]/2;let i=tB("input",e[0].dataType,e[0].dims,4),a=tB("bias",e[0].dataType,[e[0].dims[2]],4),n=tM("output",e[0].dataType,r,4),s=e6.size(r)/4,o=tS(e[0].dataType);return{name:"BiasSplitGelu",getRunData:()=>({outputs:[{dims:r,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(s/64)}}),getShaderSource:r=>`
  ...
  ${r.mainStart()}
    ...
    fn pow_vector_custom(a : vec4<${r}>, b : vec4<${r}>) -> vec4<${r}> {
      ...
      `)},io=e=>{ie(e,"Sub",(e,r)=>`${e}-${r}`)},iu=e=>{ie(e,"Greater",{scalar:(e,r)=>`u32(${e}>${r})`,vector:(e,r)=>`vec4<u32>(${e}>${r})`},void 0,void 0,9)},il=e=>{ie(e,"Less",{scalar:(e,r)=>`u32(${e}<${r})`,vector:(e,r)=>`vec4<u32>(${e}<${r})`},void 0,void 0,9)},id=e=>{ie(e,"GreaterOrEqual",{scalar:(e,r)=>`u32(${e}>=${r})`,vector:(e,r)=>`vec4<u32>(${e}>=${r})`},void 0,void 0,9)},ip=e=>{ie(e,"LessOrEqual",{scalar:(e,r)=>`u32(${e}<=${r})`,vector:(e,r)=>`vec4<u32>(${e}<=${r})`},void 0,void 0,9)}}),nj=W(()=>{nT(),nz(),nM(),nD(),ic=(e,r)=>{let i=e.inputs,a=i[0].dims,n=e6.normalizeAxis(r.axis,a.length);((e,r)=>{if(!e||e.length<1)throw Error("too few inputs");let i=e[0],a=i.dataType,n=i.dims.length;e.forEach((e,s)=>{if(0!==s){if(e.dataType!==a)throw Error("input tensors should be one type");if(e.dims.length!==n)throw Error("input tensors should have the same shape");e.dims.forEach((e,a)=>{if(a!==r&&e!==i.dims[a])throw Error("non concat dimensions must match")})}})})(i,n);let s=a.slice();s[n]=i.reduce((e,r)=>e+(r.dims.length>n?r.dims[n]:0),0);let o=i.filter(e=>e6.size(e.dims)>0);e.compute(((e,r,i,a)=>{let n=e6.size(i),s=Array(e.length),o=Array(e.length),u=0,l=[],d=[],p=[{type:12,data:n}];for(let i=0;i<e.length;++i)u+=e[i].dims[r],s[i]=u,d.push(e[i].dims.length),o[i]=tB(`input${i}`,a,d[i]),l.push("rank"),p.push({type:12,data:s[i]});for(let r=0;r<e.length;++r)p.push(...tI(e[r].dims));p.push(...tI(i));let c=tM("output",a,i.length),h=c.indicesGet("indices",r),f=Array.from(Array(s.length).keys()).map(e=>`uniforms.sizeInConcatAxis${e}`).join(",");return{name:"Concat",shaderCache:{hint:`${r}`,inputDependencies:l},getRunData:()=>({outputs:[{dims:i,dataType:a}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:p}),getShaderSource:r=>`
...
`)})(o,c)}
        ...
        `;case"":return"";default:throw Error(`Unsupported activation ${e.activation}`)}},ig=(e,r)=>{"Clip"===e.activation?r.push({type:1,data:e.clipMax},{type:1,data:e.clipMin}):"HardSigmoid"===e.activation?r.push({type:1,data:e.alpha},{type:1,data:e.beta}):"LeakyRelu"===e.activation&&r.push({type:1,data:e.alpha})},iy=(e,r)=>{"Clip"===e.activation?r.push({name:"clip_max",type:"f32"},{name:"clip_min",type:"f32"}):"HardSigmoid"===e.activation?r.push({name:"alpha",type:"f32"},{name:"beta",type:"f32"}):"LeakyRelu"===e.activation&&r.push({name:"alpha",type:"f32"})},i_=e=>{let r=e?.activation||"";if("HardSigmoid"===r){let[i,a]=e?.activation_params||[.2,.5];return{activation:r,alpha:i,beta:a}}if("Clip"===r){let[i,a]=e?.activation_params||[e9,e7];return{activation:r,clipMax:a,clipMin:i}}if("LeakyRelu"===r){let[i]=e?.activation_params||[.01];return{activation:r,alpha:i}}return{activation:r}}}),nZ=W(()=>{ib=(e,r)=>{switch(e){case 1:return r;case 2:return`vec2<${r}>`;case 3:return`vec3<${r}>`;case 4:return`vec4<${r}>`;default:throw Error(`${e}-component is not supported.`)}},i$=e=>`
...
`}),nX=W(()=>{nT(),nz(),nD(),nK(),iw=(e,r,i,a,n)=>{let s=a-i;return`
      ...
      if (${tO(r.shape,o,r.rank)} != 1) {
        ${r.indicesSet(e,o,tO(n,o+s,a))}
      } else {
        ${r.indicesSet(e,o,0)}
      }`).join("")}
`},ix=(e,r,i,a,n=!1,s)=>{let o=e[0].dims,u=e[1].dims,l=o[o.length-2],d=u[u.length-1],p=o[o.length-1],c=tE(d),h=tE(p),f=tE(l),m=e6.size(i)/c/f,g=e.length>2,y=a?a.slice(0,-2):i.slice(0,-2),_=[e6.size(y),l,d],b=[{type:12,data:m},{type:12,data:l},{type:12,data:d},{type:12,data:p}];return ig(r,b),b.push(...tI(y,o,u)),g&&b.push(...tI(e[2].dims)),b.push(...tI(_)),{name:"MatMulNaive",shaderCache:{hint:`${r.activation};${c};${h};${f};${n}`,inputDependencies:g?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(m/64)},programUniforms:b}),getShaderSource:a=>{let s=tN("batch_dims",e[0].dataType,y.length),l=tB("a",e[0].dataType,o.length,h),d=tB("b",e[1].dataType,u.length,c),p=tM("output",e[0].dataType,_.length,c),m=tS(p.type.tensor),b=im(r,p.type.value,m),$=[l,d],v="";if(g){let r=n?c:1;$.push(tB("bias",e[2].dataType,e[2].dims.length,r)),v=`${n?`value += bias[col / ${r}];`:`value += ${p.type.value}(bias[row + i]);`}`}let w=[{name:"output_size",type:"u32"},{name:"M",type:"u32"},{name:"N",type:"u32"},{name:"K",type:"u32"}];return iy(r,w),`
...
`},iI=(e,r,i,a,n=!1,s)=>{let o=e[0].dims,u=e[1].dims,l=o.slice(0,-2),d=u.slice(0,-2),p=a?a.slice(0,-2):i.slice(0,-2),c=e6.size(p),h=o[o.length-2],f=o[o.length-1],m=u[u.length-1],g=f%4==0&&m%4==0,y=h<=8?[4,1,1]:[4,4,1],_=[8,8,1],b=[Math.ceil(m/_[0]/y[0]),Math.ceil(h/_[1]/y[1]),Math.ceil(c/_[2]/y[2])],$=g?4:1,v=[...l,h,f/$],w=v.length,x=[...d,f,m/$],k=x.length,S=[c,h,m/$],T=[{type:6,data:h},{type:6,data:m},{type:6,data:f}];ig(r,T),T.push(...tI(p,v,x));let I=["rank","rank"],E=e.length>2;return E&&(T.push(...tI(e[2].dims)),I.push("rank")),T.push(...tI(S)),{name:"MatMul",shaderCache:{hint:`${y};${r.activation};${g};${n}`,inputDependencies:I},getRunData:()=>({outputs:[{dims:s?s(i):i,dataType:e[0].dataType}],dispatchGroup:{x:b[0],y:b[1],z:b[2]},programUniforms:T}),getShaderSource:i=>{let a=p.length,s=tN("batchDims",e[0].dataType,a,1),o=tS(e[0].dataType),u=tB("a",e[0].dataType,w,$),l=tB("b",e[1].dataType,k,$),d=tM("result",e[0].dataType,S.length,$),c=[u,l];if(E){let r=n?$:1;c.push(tB("bias",e[2].dataType,e[2].dims.length,r))}let h=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"}];iy(r,h);let f=tS(d.type.tensor),m=((e,r,i,a,n=!1)=>{let[s,o,u,l]=a,d=tS(a[0].type.tensor);return`
  ...
  ${g?ik(y,_,o,s):iT(y,_,o,s)}
                   `}}}}),nJ=W(()=>{nT(),nE(),nD(),nK(),nZ(),nQ(),nY(),iE=(e,r,i,a,n,s,o,u,l)=>{let d="NHWC"===r.format,p=d?e[0].dims[3]:e[0].dims[1],c=i[0],h=d?i[2]:i[3],f=d?i[1]:i[2],m=d?i[3]:i[1],g=d&&(p%4==0||p%3==0)&&m%4==0,y=d?m:h*f,_=d?h*f:m,b=[8,8,1],$=a<=8?[4,1,1]:[4,4,1],v=[Math.ceil(y/b[0]/$[0]),Math.ceil(_/b[1]/$[1]),Math.ceil(c/b[2]/$[2])];e2("verbose",()=>`[conv2d_mm_webgpu] dispatch = ${v}`);let w=g?d&&p%4!=0?3:4:1,x=b[1]*$[1],k=b[0]*$[0],S=Math.max(b[0]*w,b[1]),T=a%x==0,I=n%k==0,E=s%S==0,z=g?[w,4,4]:[1,1,1],C=[{type:6,data:a},{type:6,data:n},{type:6,data:s},{type:6,data:[r.pads[0],r.pads[1]]},{type:6,data:r.strides},{type:6,data:r.dilations}];ig(r,C),C.push(...tI(e[0].dims,e[1].dims));let A=["rank","rank"];return o&&(C.push(...tI(e[2].dims)),A.push("rank")),C.push(...tI(i)),{name:"Conv2DMatMul",shaderCache:{hint:`${r.cacheKey};${w};${g};${T};${I};${E};${x};${k};${S}`,inputDependencies:A},getRunData:()=>({outputs:[{dims:l?l(i):i,dataType:e[0].dataType}],dispatchGroup:{x:v[0],y:v[1],z:v[2]},programUniforms:C}),getShaderSource:a=>{let n=[{name:"dim_a_outer",type:"i32"},{name:"dim_b_outer",type:"i32"},{name:"dim_inner",type:"i32"},{name:"pad",type:"i32",length:2},{name:"stride",type:"i32",length:2},{name:"dilation",type:"i32",length:2}];iy(r,n);let s=g?4:1,l=tS(e[0].dataType),p=`
      ...
      }`,c=[tB("x",e[0].dataType,e[0].dims.length,3===w?1:w),tB("w",e[1].dataType,e[1].dims.length,s)],h=tM("result",e[0].dataType,i.length,s);if(o){let r=tB("bias",e[2].dataType,e[2].dims.length,s);c.push(r),p+=`
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${b}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
        ...
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${l} {
          ...
          }`}}}}),n1=W(()=>{nT(),nz(),nD(),nK(),iB=(e,r,i,a)=>{let n=e.length>2,s=n?"value += b[output_channel];":"",o=e[0].dims,u=e[1].dims,l="NHWC"===r.format,d=l?i[3]:i[1],p=d/r.group,c=l&&p>=4?tE(d):1,h=e6.size(i)/c,f=[{type:12,data:h},{type:12,data:r.dilations},{type:12,data:[r.strides[0],r.strides[1]]},{type:12,data:[r.pads[0],r.pads[1]]},{type:12,data:p}];return ig(r,f),f.push(...tI(o,[u[0],u[1],u[2],u[3]/c])),f.push(...tI([i[0],i[1],i[2],i[3]/c])),{name:"GroupedConv",shaderCache:{hint:`${r.cacheKey}_${c}`,inputDependencies:n?["rank","rank","rank"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(h/64)},programUniforms:f}),getShaderSource:a=>{let d=tM("output",e[0].dataType,i.length,c),p=tS(d.type.tensor),h=im(r,d.type.value,p),f=tB("x",e[0].dataType,o.length),m=tB("w",e[1].dataType,u.length,c),g=[f,m];n&&g.push(tB("b",e[2].dataType,e[2].dims,c));let y=[{name:"output_size",type:"u32"},{name:"dilations",type:"u32",length:r.dilations.length},{name:"strides",type:"u32",length:2},{name:"pads",type:"u32",length:2},{name:"output_channels_per_group",type:"u32"}];iy(r,y);let _=l?`
  ...
  }`}}},iM=(e,r,i,a)=>{let n=e.length>2,s=tE(i[3]),o=tE(i[2]),u=e6.size(i)/s/o,l=[e[0].dims[0],e[0].dims[1],e[0].dims[2],e[0].dims[3]/s],d=[e[1].dims[0],e[1].dims[1],e[1].dims[2],e[1].dims[3]/s],p=[i[0],i[1],i[2],i[3]/s],c=[{type:12,data:u},{type:6,data:[r.strides[0],r.strides[1]]},{type:6,data:[r.pads[0],r.pads[1]]}];ig(r,c),c.push(...tI(l,d,p));let h=(o-1)*r.strides[1]+d[1];return{name:"GroupedConv-Vectorize",shaderCache:{hint:`${r.cacheKey};${s};${o};${h};${d[0]};${d[1]}`,inputDependencies:n?["rank","rank","type"]:["rank","rank"]},getRunData:()=>({outputs:[{dims:a?a(i):i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(u/64)},programUniforms:c}),getShaderSource:i=>{let a=tM("output",e[0].dataType,p.length,s),u=tS(a.type.tensor),c=im(r,a.type.value,u),f=tB("x",e[0].dataType,l.length,s),m=tB("w",e[1].dataType,d.length,s),g=[f,m];n&&g.push(tB("b",e[2].dataType,e[2].dims,s));let y=[{name:"output_size",type:"u32"},{name:"strides",type:"i32",length:2},{name:"pads",type:"i32",length:2}];return iy(r,y),`
...
`},i2=(e,r)=>[r,e.length,e.inputComponents,e.outputComponents,e.inverse,e.onesided].join(";"),i3=e=>[{type:12,data:e.batch},{type:12,data:e.signalLength},{type:12,data:e.inner},{type:12,data:e.outputLength}],i4=(e,r,i)=>e.registerUniform("batch","u32").registerUniform("signalLength","u32").registerUniform("inner","u32").registerUniform("outputLength","u32").declareVariables(r,i),i6=e=>{if(!e||0===e.dataType)return;if(1!==e6.size(e.dims))throw Error("DFT optional scalar inputs must have exactly 1 element.");if(6===e.dataType)return e.getInt32Array()[0];let r=Number(e.getBigInt64Array()[0]);if(!Number.isSafeInteger(r))throw Error("DFT optional scalar inputs are out of JavaScript safe integer range.");return r},i8=(e,r)=>{(e=>{if(!e||e.length<1)throw Error("DFT requires at least 1 input.");let r=e[0].dims;if(r.length<2)throw Error("DFT input must have at least 2 dimensions.");let i=r[r.length-1];if(1!==i&&2!==i)throw Error("DFT input's innermost dimension must be 1 (real) or 2 (complex).")})(e.inputs);let i=e.inputs[0],a=i.dims.length,n=0!==r.inverse,s=0!==r.onesided,o=i6(e.inputs[1]);if(void 0!==o&&o<=0)throw Error("dft_length must be greater than zero.");let u=e6.normalizeAxis(i6(e.inputs[2])??r.axis,a);if(u===a-1)throw Error("DFT axis must refer to a signal dimension, not the innermost (real/imaginary) dimension.");if(n&&s&&2!==i.dims[a-1])throw Error("Inverse one-sided DFT (IRFFT) requires complex-valued input (innermost dimension 2).");let l=((e,r,i,a,n)=>{let s=e.dims,o=s.length,u=s[o-1],l=s[r],d=i&&a?(l-1)*2:l;void 0!==n&&(d=n);let p=i&&a?1:2,c=a&&!i?Math.floor(d/2)+1:d,h=s.slice();h[r]=c,h[o-1]=p;let f=1;for(let e=r+1;e<o-1;e++)f*=s[e];let m=e6.size(s)/u/l;return{dataType:e.dataType,outputDims:h,length:d,signalLength:l,inner:f,batch:m,inputComponents:u,outputComponents:p,outputLength:c,inverse:i,onesided:a}})(i,u,n,s,o);if(l.length<=0)throw Error(`Invalid DFT length: ${l.length}`);let d=l.length<=512&&void 0!==iJ(l.length)?(e=>{let{dataType:r,length:i,inputComponents:a,outputComponents:n,inverse:s,onesided:o}=e,u=tT(r),l=s?1:-1,d=s?1/i:1,p=iJ(i);return{name:"DFT",shaderCache:{hint:i2(e,"fft"),inputDependencies:["type"]},getShaderSource:e=>{let c=tB("x",r,[1]),h=tM("y",r,[1]),f=e=>{let r=`inBase + (${e}) * uniforms.inner * ${a}u`,i=`f32(${c.getByOffset(r)})`,n=2===a?`f32(${c.getByOffset(`${r} + 1u`)})`:"0.0";return`vec2<f32>(${i}, ${n})`},m;if(s&&o){let e=Math.floor(i/2)+1,r=i%2==0?`select(provided, provided - 1u, provided == ${e}u)`:"provided";m=`
    ...
    workgroupBarrier();`;let{code:g,resultOffset:y}=((e,r,i)=>{let a="",n=1,s=0;for(let o of e)a+=i1(o,n,r,s,i),n*=o,s=512-s;return{code:a,resultOffset:s}})(p,i,l),_=1===d?`smem[${y}u + i]`:`smem[${y}u + i] * ${i0(d)}`,b=2===n?h.setByOffset("off + 1u",`${u}(v.y)`):"";return`
  ${i4(e,c,h)}
...
${g}    for (var i = local_idx; i < uniforms.outputLength; i += 256u) {
  ...
  }`},getRunData:()=>({outputs:[{dims:e.outputDims,dataType:r}],programUniforms:i3(e),dispatchGroup:{x:e.batch}})}})(l):(e=>{let{dataType:r,length:i,inputComponents:a,outputComponents:n,inverse:s,onesided:o}=e,u=tT(r),l=s?1:-1,d=s?1/i:1;return{name:"DFT",shaderCache:{hint:i2(e,"direct"),inputDependencies:["type"]},getShaderSource:e=>{let p=tB("x",r,[1]),c=tM("y",r,[1]),h=e=>{let r=`inBase + (${e}) * uniforms.inner * ${a}u`,i=`f32(${p.getByOffset(r)})`,n=2===a?`f32(${p.getByOffset(`${r} + 1u`)})`:"0.0";return`vec2<f32>(${i}, ${n})`},f=s&&o?`fn spectrum(inBase: u32, k: u32) -> vec2<f32> {
...
`)};
    ...
    ${e.mainStart(tx)}
    ...
    }`},getRunData:e=>({outputs:[{dims:e[0].dims,dataType:e[0].dataType}],programUniforms:[{type:12,data:Math.ceil(i/4)},{type:12,data:a}],dispatchGroup:{x:Math.ceil(i/tx/4)}})}})(e.inputs))}}),st=W(()=>{nT(),nz(),nM(),nD(),al=e=>tw({axis:e.axis}),ad=(e,r)=>{(e=>{if(!e||2!==e.length)throw Error("Gather requires 2 inputs.")})(e.inputs),e.compute(((e,r)=>{let i=e[0].dims,a=e[1].dims,n=i.length,s=e6.normalizeAxis(r.axis,n),o=i.slice(0);o.splice(s,1,...a);let u=i[s],l=9===e[0].dataType?4:1,d=Math.ceil(e6.size(o)/l),p=[{type:12,data:d},{type:6,data:u},{type:12,data:s},...tI(e[0].dims,e[1].dims,o)];return{name:"Gather",shaderCache:{hint:r.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:o,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(d/64)},programUniforms:p}),getShaderSource:r=>{let i=tB("data",e[0].dataType,e[0].dims.length,l),u=tB("inputIndices",e[1].dataType,e[1].dims.length),d=tM("output",e[0].dataType,o.length,l),p=e=>{let r=a.length,l=`var indicesIndices${e}  = ${u.type.indices}(0);`;for(let i=0;i<r;i++)l+=`${r>1?`indicesIndices${e}[${i}]`:`indicesIndices${e}`} = ${o.length>1?`outputIndices${e}[uniforms.axis + ${i}]`:`outputIndices${e}`};`;l+=`
      ...
      ${r.mainStart()}
        ${r.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
        ${c}
      }`}}})(e.inputs,r))}}),sr=W(()=>{nT(),nz(),nD(),ap=(e,r)=>{let i=e.inputs,a=i[0].dims,n=i[0].dataType,s=i[1].dims,o=s[s.length-1],u=e6.sizeToDimension(s,s.length-1),l=e6.sizeFromDimension(a,r.batchDims+o),d=e6.sizeToDimension(a,r.batchDims),p=e6.sizeFromDimension(a,r.batchDims),c=Array(o),h=l;for(let e=0;e<o;++e)c[o-1-e]=h,h*=a[r.batchDims+o-1-e];let f=((e,r,i,a,n,s,o,u,l)=>{let d=[{type:12,data:s},{type:12,data:a},{type:12,data:n},{type:12,data:i},{type:12,data:o},{type:12,data:u},{type:12,data:l}],p=[s];return d.push(...tI(r.dims,p)),e.compute({name:"computeSliceOffsets",shaderCache:{hint:`${n.length}_${i.length}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:p,dataType:e.inputs[1].dataType}],dispatchGroup:{x:Math.ceil(s/64)},programUniforms:d}),getShaderSource:e=>{let a=tB("indices_data",r.dataType,r.dims.length),s=tM("input_slice_offsets_data",12,1,1),o=[{name:"output_size",type:"u32"},{name:"batch_dims",type:"u32"},{name:"input_dims",type:"u32",length:n.length},{name:"sizes_from_slice_dims_data",type:"u32",length:i.length},{name:"num_slices_per_batch",type:"u32"},{name:"input_batch_stride",type:"u32"},{name:"num_slice_dims",type:"u32"}];return`
  ...
  ${e.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
  }`}},{inputs:[r],outputs:[-1]})[0]})(e,i[1],c,r.batchDims,a,u,u/d,p,o),m=r.batchDims+o;if(m>a.length)throw Error("last dimension of indices must not be larger than rank of input tensor");let g=s.slice(0,-1).concat(a.slice(m)),y=e6.size(g),_=[{type:12,data:y},{type:12,data:l},...tI(i[0].dims,f.dims,g)];e.compute({name:"GatherND",shaderCache:{hint:r.cacheKey,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:g,dataType:n}],dispatchGroup:{x:Math.ceil(y/64)},programUniforms:_}),getShaderSource:e=>{let r=tB("data",i[0].dataType,i[0].dims.length),a=tB("slice_offsets",12,f.dims.length),n=tM("output",i[0].dataType,g.length);return`
          ${e.registerUniform("output_size","u32").registerUniform("slice_size","u32").declareVariables(r,a,n)}
            ${e.mainStart()}
            ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
          let slice_offset = slice_offsets[global_idx / uniforms.slice_size];
          output[global_idx] = data[u32(slice_offset) + global_idx % uniforms.slice_size];
        }`}},{inputs:[i[0],f]})},ac=e=>({batchDims:e.batch_dims,cacheKey:""})}),si=W(()=>{nT(),nz(),nM(),nD(),ah=(e,r)=>{((e,r)=>{if(e.length<3||e.length>4)throw Error("GatherBlockQuantized requires 3 or 4 inputs.");let i=e6.normalizeAxis(r.quantizeAxis,e[0].dims.length),a=r.blockSize,n=e[0],s=e[2],o=4===e.length?e[3]:void 0;if(s.dims.length!==n.dims.length||!n.dims.map((e,r)=>r===i?Math.ceil(e/a)===s.dims[r]:e===s.dims[r]).reduce((e,r)=>e&&r,!0))throw Error("Scales must have the same rank as the input tensor and the dims should match except on gatherAxis.");if(o){if(o.dataType!==n.dataType)throw Error("Zero point must have the same data type as the input tensor.");if(o.dims.length!==s.dims.length||!o.dims.map((e,r)=>e===s.dims[r]).reduce((e,r)=>e&&r,!0))throw Error("Zero point must have the same rank as the input tensor and the dims should match except on quantizeAxis.")}})(e.inputs,r),e.compute(((e,r)=>{let i=e[0].dims,a=e[1].dims,n=i.length,s=e6.normalizeAxis(r.gatherAxis,n),o=e6.normalizeAxis(r.quantizeAxis,n),u=i.slice(0);u.splice(s,1,...a);let l=e6.size(u),d=e[2].dataType,p=22===e[0].dataType,c=[{type:12,data:l},{type:12,data:o},{type:12,data:s},{type:12,data:r.blockSize},...tI(...e.map((e,r)=>e.dims),u)];return{name:"GatherBlockQuantized",shaderCache:{hint:`${r.cacheKey};${e.filter((e,r)=>1!==r).map(e=>e.dims.join("_")).join(";")}`,inputDependencies:Array.from({length:e.length},(e,r)=>"rank")},getRunData:()=>({outputs:[{dims:u,dataType:d}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:c}),getShaderSource:r=>{let n=tB("data",e[0].dataType,e[0].dims.length),o=tB("inputIndices",e[1].dataType,e[1].dims.length),l=tB("scales",e[2].dataType,e[2].dims.length),c=e.length>3?tB("zeroPoint",e[3].dataType,e[3].dims.length):void 0,h=tM("output",d,u.length),f=[n,o,l];return c&&f.push(c),`
        ...
        ${h.setByOffset("global_idx","dequantized_data")};
                     ...
                     indices input tensors be of same rank.`)})(e.inputs),e.compute(((e,r)=>{let i=e[0].dims,a=e[0].dataType,n=i.length,s=e[1].dims,o=e[1].dataType,u=e6.normalizeAxis(r.axis,n),l=i[u],d=s.slice(0),p=e6.size(d),c=tB("input",a,n),h=tB("indicesInput",o,s.length),f=tM("output",a,d.length),m=[{type:12,data:p},{type:6,data:l},{type:12,data:u}];return m.push(...tI(i,s,d)),{name:"GatherElements",shaderCache:{inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:d,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(p/64)},programUniforms:m}),getShaderSource:e=>`
  ...
  }`}}})(e.inputs,r))}}),ss=W(()=>{nT(),nz(),nM(),nD(),[ab,a$,av,aw]=[0,1,2,3],ax=`
...
`,ak=(e,r)=>{(e=>{if(4!==e[0].dims.length)throw Error("only 4-D tensor is supported.");if(e[0].dims.length!==e[1].dims.length)throw Error("input dimensions must be equal to grid dimensions");if(e[0].dims.length-2!==e[1].dims[e[1].dims.length-1])throw Error(`last dimension of grid must be equal to ${e[0].dims.length-2}`);if(e[0].dims[0]!==e[1].dims[0])throw Error("grid batch size must match input batch size")})(e.inputs),e.compute(((e,r)=>{let i=tB("x",e[0].dataType,e[0].dims.length),a=[e[1].dims[0],e[1].dims[1],e[1].dims[2]],n=tB("grid",e[1].dataType,a.length,2),s=[e[0].dims[0],e[0].dims[1],e[1].dims[1],e[1].dims[2]];"NHWC"===r.format&&(s=[e[0].dims[0],e[1].dims[1],e[1].dims[2],e[0].dims[3]],[ab,a$,av,aw]=[0,3,1,2]);let o=tM("output",e[0].dataType,s.length),u=i.type.value,l=[{type:12,data:e6.size(s)},...tI(e[0].dims,a,s)];return{name:"GridSample",shaderCache:{hint:`${r.cacheKey}`,inputDependencies:["type","type"]},getRunData:e=>{let r=e6.size(s);return{outputs:[{dims:s,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(r/64)},programUniforms:l}},getShaderSource:e=>{let a,s;return`
...
`}
  ...
  fn pixel_at_grid(r: i32, c: i32, H: i32, W: i32, batch: u32, channel: u32, border: vec4<f32>) -> ${r} {
     ...
     indices[${ab}] = batch;
     indices[${a$}] = channel;`+(()=>{switch(i.paddingMode){case"zeros":return`
          if (r >= 0 && r < H && c >=0 && c < W) {
            indices[${av}] = u32(r);
            indices[${aw}] = u32(c);
          } else {
...
`)(i,u,r)}
  ...
  ${e.mainStart()}
    ${e.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      var grid_indices = vec3<u32>(indices[${ab}], indices[${av}], indices[${aw}]);
      let nxy = ${n.getByIndices("grid_indices")};
      var x = gs_denormalize(f32(nxy[0]), W_in);
      var y = gs_denormalize(f32(nxy[1]), H_in);

      ${((e,r,i)=>(()=>{switch(i.mode){case"nearest":return`
          let result = pixel_at_grid(i32(round(y)), i32(round(x)), H_in, W_in, indices[${ab}], indices[${a$}], border);
        `;case"bilinear":return`
          ...
          let p11 = pixel_at_grid(y1, x1, H_in, W_in, indices[${ab}], indices[${a$}], border);
          let p12 = pixel_at_grid(y1, x2, H_in, W_in, indices[${ab}], indices[${a$}], border);
          let p21 = pixel_at_grid(y2, x1, H_in, W_in, indices[${ab}], indices[${a$}], border);
          let p22 = pixel_at_grid(y2, x2, H_in, W_in, indices[${ab}], indices[${a$}], border);
        ...
        `;case"bicubic":return`
          ...
          for (var h = 0; h < 4; h++) {
            for (var w = 0; w < 4; w++) {
              p[h][w] = pixel_at_grid(h + y0, w + x0, H_in, W_in, indices[${ab}], indices[${a$}], border);
            }
          }
...
`)}
  ...
  }`,getRunData:()=>({outputs:d,dispatchGroup:{x:Math.ceil(a/64)},programUniforms:h})}},aO=(e,r)=>{(e=>{if(!e||e.length<1)throw Error("too few inputs")})(e.inputs);let i=1===e.inputs.length?r:((e,r)=>{let i=[],a=r.numOutputs;return e[1].dims[0]>0&&(e[1].getBigInt64Array().forEach(e=>i.push(Number(e))),a=i.length),tw({numOutputs:a,axis:r.axis,splitSizes:i})})(e.inputs,r);e.compute(aA(e.inputs,i),{inputs:[0]})},aR=e=>{let r=e.axis,i=e.splitSizes,a=e.numOutputs<0?i.length:e.numOutputs;if(a!==i.length)throw Error("numOutputs and splitSizes length must be equal");return tw({axis:r,numOutputs:a,splitSizes:i})}}),sl=W(()=>{nT(),nz(),nM(),nD(),aB=(e,r)=>{let{interleaved:i,numHeads:a,rotaryEmbeddingDim:n,scale:s}=r,o=e[0].dims[0],u=e6.sizeFromDimension(e[0].dims,1),l=e[0].dims[e[0].dims.length-2],d=u/l,p=e[2].dims[1],c=0===n?2*p:d/a,h=[o,l,d/c,c-p],f=e6.computeStrides(h),m=[{type:1,data:s},{type:12,data:h},{type:12,data:f},...3===e[0].dims.length?Array({type:12,data:[u,d,c,1]}):[],...4===e[0].dims.length?Array({type:12,data:[u,c,l*c,1]}):[],...tI(e[0].dims,e[1].dims,e[2].dims,e[3].dims,e[0].dims)];return{name:"RotaryEmbedding",shaderCache:{hint:tw({interleaved:i}).cacheKey,inputDependencies:["rank","rank","rank","rank"]},getShaderSource:r=>{let a=tB("input",e[0].dataType,e[0].dims.length),n=tB("position_ids",e[1].dataType,e[1].dims.length),s=tB("cos_cache",e[2].dataType,e[2].dims.length),o=tB("sin_cache",e[3].dataType,e[3].dims.length),u=tM("output",e[0].dataType,e[0].dims.length);return r.registerUniforms([{name:"scale",type:"f32"},{name:"global_shape",type:"u32",length:h.length},{name:"global_strides",type:"u32",length:f.length},{name:"input_output_strides",type:"u32",length:f.length}]),`
  ...
  `}}})(i.batchSize,i.sequenceLength,l,d),{inputs:[l,d],outputs:[-1]})[0],n=e.inputs[7],s=e.inputs[8],o=tw({interleaved:0!==r.rotaryInterleaved,numHeads:i.numHeads,rotaryEmbeddingDim:0,scale:r.scale}),u=[h,a,n,s],p=[-1];g=e.compute(aB(u,o),{inputs:u,outputs:p})[0],u.splice(0,1,f);let c=tw({interleaved:0!==r.rotaryInterleaved,numHeads:i.kvNumHeads,rotaryEmbeddingDim:0,scale:r.scale});y=e.compute(aB(u,c),{inputs:u,outputs:p})[0]}let _=az(e,i.batchSize,i.numHeads,i.sequenceLength,i.headSize,r.doRotary?g:h,void 0,0),b=aN(e,r.doRotary?y:f,i),$=aN(e,m,i);rg(e,_,b,$,void 0,void 0,o,u,void 0,i,l,d)}}),sp=W(()=>{nT(),nz(),nN(),nD(),aP=(e,r,i,a,n,s,o,u)=>{let l=tE(s),d=1===l?"f32":`vec${l}f`,p=1===l?"vec2f":`mat2x${l}f`,c=n*o,h=64;1===c&&(h=256);let f=[n,o,s/l],m=[n,o,2],g=[];return g.push(...tI(f,m)),e.compute({name:"InstanceNormComputeChannelScaleShift",shaderCache:{hint:`${l};${u};${h}`,inputDependencies:["rank","type","type"]},getRunData:()=>({outputs:[{dims:m,dataType:1}],dispatchGroup:{x:c},programUniforms:g}),getShaderSource:e=>{let n=tB("x",r.dataType,3,l),s=[n,tB("scale",i.dataType,i.dims),tB("bias",a.dataType,a.dims),tM("output",1,3,2)];return`
  ...
  }`}},{inputs:[r,i,a],outputs:[-1]})[0]},aq=(e,r)=>{"NHWC"===r.format?((e,r,i)=>{let a=r[0].dims,n=a[0],s=a[a.length-1],o=e6.sizeFromDimension(a,1)/s,u=tE(s),l=e6.size(a)/u,d=[{type:12,data:o},{type:12,data:Math.floor(s/u)}],p=!1,c=[0,a.length-1];for(let e=0;e<a.length-2;e++)p=p||1!==a[e+1],c.push(e+1);let h=(p=p&&1!==a[a.length-1])?e.compute(tL(e.inputs[0],c),{inputs:[e.inputs[0]],outputs:[-1]})[0]:e.inputs[0].reshape(Array.from({length:a.length},(e,r)=>a[c[r]])),f=aP(e,h,r[1],r[2],n,o,s,i.epsilon);e.compute({name:"InstanceNormalizationNHWC",shaderCache:{hint:`${u}`,inputDependencies:["type","type"]},getRunData:()=>({outputs:[{dims:a,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:d}),getShaderSource:e=>{let i=tS(r[0].dataType),n=1===u?"vec2f":`mat${u}x2f`,s=e=>{let r=0===e?"x":"y",a=1===u?"f32":`vec${u}f`;switch(u){case 1:return`${i}(${a}(scale.${r}))`;case 2:return`vec2<${i}>(${a}(scale[0].${r}, scale[1].${r}))`;case 4:return`vec4<${i}>(${a}(scale[0].${r}, scale[1].${r}, scale[2].${r}, scale[3].${r}))`;default:throw Error(`Not supported compoents ${u}`)}},o=tB("input",r[0].dataType,r[0].dims,u),l=tM("output",r[0].dataType,a,u);return`
  ...
  }`}},{inputs:[r[0],f]})})(e,e.inputs,r):((e,r,i)=>{let a=r[0].dims,n=a[0],s=a[1],o=e6.sizeFromDimension(a,2),u=tE(o),l=e6.size(a)/u,d=aP(e,r[0],r[1],r[2],n,o,s,i.epsilon),p=[n,s,o/u],c=[n,s];e.compute({name:"InstanceNormalization",shaderCache:{hint:`${u}`,inputDependencies:["type","none"]},getRunData:()=>({outputs:[{dims:a,dataType:r[0].dataType}],dispatchGroup:{x:Math.ceil(l/64)},programUniforms:[{type:12,data:l},...tI(p,c,p)]}),getShaderSource:e=>{let i=tB("x",r[0].dataType,p.length,u),a=tB("scale_shift",1,c.length,2),n=tM("output",r[0].dataType,p.length,u),s=[i,a,n];return`
  ...
  ${r.mainStart()}
    ...
    ${_?"inv_std_output[global_idx] = inv_std_dev":""};
        ...
        }`}}})(e.inputs,r)):e.compute(((e,r)=>{let i=e[0].dims,a=i.length,n=i[a-2],s=r.k,o=r.n,u=i.slice(0,a-2),l=e6.size(u),d=e[1].dims[2]/4,p=e[0].dataType,c=tE(r.k),h=tE(d),f=tE(o),m=u.concat([n,o]),g=n>1&&o/f%2==0?2:1,y=e6.size(m)/f/g,_=[],b=[l,n,s/c],$=e6.convertShape(e[1].dims).slice();$.splice(-1,1,d/h),_.push(...tI(b)),_.push(...tI($)),_.push(...tI(e[2].dims)),4===e.length&&_.push(...tI(e6.convertShape(e[3].dims)));let v=[l,n,o/f];return _.push(...tI(v)),{name:"MatMulNBits",shaderCache:{hint:`${r.blockSize};${r.bits};${c};${h};${f};${g};64`,inputDependencies:Array(e.length).fill("rank")},getRunData:()=>({outputs:[{dims:m,dataType:p}],dispatchGroup:{x:y},programUniforms:_}),getShaderSource:i=>{let a=b.length,n=tB("a",e[0].dataType,a,c),s=tB("b",12,$.length,h),o=tB("scales",e[2].dataType,e[2].dims.length),u=[n,s,o],l=4===e.length?tB("zero_points",12,e[3].dims.length):void 0;l&&u.push(l);let p=v.length,m=tM("output",e[0].dataType,p,f),y=tS(e[0].dataType),_=(()=>{switch(c){case 1:return`array<${y}, 8>`;case 2:return`mat4x2<${y}>`;case 4:return`mat2x4<${y}>`;default:throw Error(`${c}-component is not supported.`)}})(),w=Math.floor(32/r.bits),x=Math.floor(w/8);return`
      ...
      `})(e,r,i.pads.length);case 1:return((e,r,i)=>{let a="";for(let n=r-1;n>=0;--n)a+=`
                ...
                {
                  let _2n_1 = 2 * (i32(${tO("uniforms.x_shape",n,r)}) - 1);
                  k = k % _2n_1;
                  if(k >= i32(${tO("uniforms.x_shape",n,r)})) {
                    k = _2n_1 - k;
                  }
          ...
          `})(e,r,i.pads.length);case 2:return((e,r,i)=>{let a="";for(let n=r-1;n>=0;--n)a+=`
                ...
                if (k >= i32(${tO("uniforms.x_shape",n,r)})) {
                  k = i32(${tO("uniforms.x_shape",n,r)}) - 1;
                }
                offset += k * i32(${tO("uniforms.x_strides",n,r)});
            `;return`
              var offset = 0;
    ...
    `,u=tB("x",r.dataType,r.dims.length),[l,d,p,c,h]=aK(s,n);return l.push(...tI(r.dims,s)),{name:e,shaderCache:{hint:`${a.cacheKey};${p};${c};${h}`,inputDependencies:["rank"]},getRunData:()=>({outputs:[{dims:s,dataType:r.dataType}],dispatchGroup:{x:Math.ceil(e6.size(s)/64)},programUniforms:l}),getShaderSource:e=>aZ(e,u,r.dims.length,s.length,n,o,"",10===r.dataType?-65504:-1e5,d,p,c,h)}},a6=(e,r)=>{aF(e.inputs),e.compute(a4("MaxPool",e.inputs[0],!1,r))},a8=e=>{let r=e.storage_order,i=e.dilations,a=aX(e);if(0!==r)throw Error("column major storage order is not yet supported for MaxPool");if(0!==a.ceilMode)throw Error("ceil_mode output-shape is computed, but ceil_mode kernel execution (padding) is not yet implemented in the WebGPU MaxPool kernel");let n={storageOrder:r,dilations:i,...a,cacheKey:""};return{...n,cacheKey:(e=>`${aQ(e)};${e.storageOrder};${e.dilations}`)(n)}},a5=e=>{let r=e.format;return{format:r,...a1,cacheKey:r}},a9=(e,r)=>{aF(e.inputs),e.compute(a4("GlobalMaxPool",e.inputs[0],!0,r))}}),sy=W(()=>{nT(),nz(),nM(),nD(),a7=(e,r)=>{((e,r)=>{if(e.length<2||e.length>3)throw Error("DequantizeLinear requires 2 or 3 inputs.");if(3===e.length&&e[1].dims===e[2].dims)throw Error("x-scale and x-zero-point must have the same shape.");if(3===e.length&&e[0].dataType!==e[2].dataType)throw Error("x and x-zero-point must have the same data type.");if(0!==e[1].dims.length&&1!==e[1].dims.length&&e[1].dims.length!==e[0].dims.length)throw Error("scale input must be a scalar, a 1D tensor, or have the same rank as the input tensor.");if(e.length>2){if(e[0].dataType!==e[2].dataType)throw Error("x and x-zero-point must have the same data type.");if(e[1].dims.length!==e[2].dims.length)throw Error("scale and zero-point inputs must have the same rank.");if(!e[1].dims.map((r,i)=>r===e[2].dims[i]).reduce((e,r)=>e&&r,!0))throw Error("scale and zero-point inputs must have the same shape.")}if(r.blockSize>0){if(0===e[1].dims.length||1===e[1].dims.length&&1===e[1].dims[0])throw Error("blockSize must be set only for block quantization.");if(!e[1].dims.map((i,a)=>a===r.axis||i===e[0].dims[a]).reduce((e,r)=>e&&r,!0))throw Error("For block qunatization, scale input shape to match the input shape except for the axis");if(e[1].dims.length!==e[0].dims.length)throw Error("For block qunatization the scale input rank must be the same as the x rank.");let i=e[0].dims[r.axis],a=e[1].dims[r.axis];if(r.blockSize<Math.ceil(i/a)||r.blockSize>Math.ceil(i/(a-1)-1))throw Error("blockSize must be with in the range [ceil(dI / Si), ceil(dI / (Si - 1) - 1)].")}})(e.inputs,r),e.compute(((e,r)=>{let i=e6.normalizeAxis(r.axis,e[0].dims.length),a=e[0].dataType,n=3===a,s=e[0].dims,o=e[1].dataType,u=e6.size(s),l=3===a||2===a,d=l?[Math.ceil(e6.size(e[0].dims)/4)]:e[0].dims,p=e[1].dims,c=e.length>2?e[2]:void 0,h=c?l?[Math.ceil(e6.size(c.dims)/4)]:c.dims:void 0,f=0===p.length||1===p.length&&1===p[0],m=!1===f&&1===p.length,g=tE(u),y=f&&(!l||4===g),_=y?g:1,b=tB("input",l?12:a,d.length,y&&!l?g:1),$=tB("scale",o,p.length),v=c?tB("zero_point",l?12:a,h.length):void 0,w=tM("output",o,s.length,_),x=[b,$];v&&x.push(v);let k=[d,p];c&&k.push(h);let S=[{type:12,data:u/_},{type:12,data:i},{type:12,data:r.blockSize},...tI(...k,s)];return{name:"DequantizeLinear",shaderCache:{hint:r.cacheKey,inputDependencies:v?["rank","rank","rank"]:["rank","rank"]},getShaderSource:e=>`
      ...
      }`},getRunData:()=>({outputs:[{dims:s,dataType:a}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:o})}})(r,i,a,e.inputs[0].dataType),{inputs:[]})}}),sb=W(()=>{nT(),nz(),nM(),nD(),nr=e=>tw({reduction:e.reduction}),ni=(e,r)=>{e.compute(((e,r)=>{let i=e[0].dims,a=e[1].dims,n=Math.ceil(e6.sizeToDimension(a,a.length-1)/1),s=a[a.length-1],o=e6.sizeFromDimension(i,s),u=[{type:12,data:n},{type:12,data:s},{type:12,data:o},...tI(e[1].dims,e[2].dims,i)];return{name:"ScatterND",shaderCache:{hint:`${r.cacheKey}_${r.reduction}`,inputDependencies:["rank","rank"]},getRunData:()=>({outputs:[{dims:i,dataType:e[0].dataType}],dispatchGroup:{x:Math.ceil(n/64)},programUniforms:u}),getShaderSource:a=>{let n=tB("indices",e[1].dataType,e[1].dims.length),s=tB("updates",e[2].dataType,e[2].dims.length,1),o="none"!==r.reduction&&""!==r.reduction?tD("output",e[0].dataType,i.length):tM("output",e[0].dataType,i.length,1);return`
  ...
  for (var i = 0u; i < uniforms.num_updates_elements; i++) {
    ...
    ${((e,r,i,a)=>{if("none"!==e&&"i32"!==a&&"u32"!==a&&"f32"!==a)throw Error(`Input ${a} is not supported with reduction ${e}.`);let n=`{
      ...
      }`}}})(e.inputs,r),{inputs:[e.inputs[1],e.inputs[2]],outputs:[]})}}),s$=W(()=>{nT(),nz(),nM(),nD(),na=(e,r,i,a)=>`
...
`:"",ns=(e,r)=>{let i=[],a=[],n=[],s=(e=>{let r=e.customDataBuffer;return new Uint32Array(r.buffer,r.byteOffset,1)[0]})(e);if(0!==r.antialias)throw Error("Only default value (0) for Antialias attribute is supported");((e,r,i,a,n,s)=>{let[o,u,l]=i>10?[1,2,3]:[-1,e.length>1?1:-1,-1],d=e[0].dims.length;if(o>0&&e.length>o&&e[o].dims.length>0)e[o].getFloat32Array().forEach(e=>s.push(e));else if("tf_crop_and_resize"===r.coordinateTransformMode)throw Error("Resize requires RoI input to be specified when coordinateTransformMode is tfCropAndResize");if(u>0&&e.length>u&&1===e[u].dims.length&&e[u].dims[0]>0){if(e[u].getFloat32Array().forEach(e=>a.push(e)),0!==a.length&&a.length!==d&&i>=18&&a.length!==r.axes.length)throw Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");((e,r)=>{if(e.every(e=>e>0||(()=>{throw Error("Resize requires scales input values to be positive")})),e.length>0){if("linear"===r.mode){if(2!==e.length&&3!==e.length&&(4!==e.length||1!==e[0]||1!==e[1])&&(4!==e.length||1!==e[0]||1!==e[3])&&(5!==e.length||1!==e[0]||1!==e[1]))throw Error(`For linear mode, Resize requires scales to be 2D, 3D, 4D with either two outermost or one innermost and
    ...
    fn checkInputIndices(input_indices: ${e.type.indices}) -> bool {
      for (var i:u32 = 0; i < ${r.length}; i++) {
        ...
        if (input_index < 0 || input_index >= ${tO("uniforms.input_shape","i",r.length)}) {
          return false;
        }
      }
      return true;
    ...
    fn calculateInputIndicesFromOutputIndices(output_indices: ${r.type.indices}) -> ${e.type.indices} {
      ...
      for (var i:u32 = 0; i < ${a.length}; i++) {
        ...
        var input_index: u32;
        var scale = ${tO("uniforms.scales","i",n)};
        if (scale == 1.0) {
          input_index = output_index;
        } else {
          var roi_low = ${tO("uniforms.roi","i",s)};
          var roi_hi = ${tO("uniforms.roi",`i + ${i.length}`,s)};
          var input_shape_i = ${tO("uniforms.input_shape","i",i.length)};
          var output_shape_i = ${tO("uniforms.output_shape","i",a.length)};
    ...
    fn calculateOriginalIndicesFromOutputIndices(output_indices: ${e.type.indices}) -> array<${e.type.value}, ${i.length}> {
      ...
      for (var i:u32 = 0; i < ${i.length}; i++) {
        ...
        var scale = ${tO("uniforms.scales","i",a)};
        var roi_low = ${tO("uniforms.roi","i",n)};
        var roi_hi = ${tO("uniforms.roi",`i + ${r.length}`,n)};
        if (scale == 1.0) {
          original_indices[i] = ${e.type.value}(output_index);
        } else {
          var input_shape_i = ${tO("uniforms.input_shape","i",r.length)};
          var output_shape_i = ${tO("uniforms.output_shape","i",i.length)};
...
`}
      ...
      ${r.mainStart([64,1,1])}
        ...
        let mean = ${tA("sum",m)} / f32(uniforms.hidden_size);
        let inv_std_dev = inverseSqrt(${tA("square_sum",m)} / f32(uniforms.hidden_size) ${n?"":"- mean * mean"} + uniforms.epsilon);
      ...
      ${e.registerUniforms(m).declareVariables(h,c)}
        ${((e,r,i)=>`fn calculateInputIndices(output_indices: ${r.type.indices}) -> ${e.type.indices} {
          ...
          for (var i = ${i.length-1}; i >= 0; i--) {
            let input_shape_i = ${tO("uniforms.input_shape","i",i.length)};
            let steps_i = ${tO("uniforms.steps","i",i.length)};
            let signs_i = ${tO("uniforms.signs","i",i.length)};
            let starts_i = ${tO("uniforms.starts","i",i.length)};
            var output_index = ${r.indicesGet("output_indices","i")};
      ...
      }`,getRunData:()=>({outputs:[p],dispatchGroup:{x:Math.ceil(a/64)},programUniforms:g})}})(e.inputs,i),{inputs:[0]})},nc=e=>{let r=e.starts,i=e.ends,a=e.axes;return tw({starts:r,ends:i,axes:a})}}),sx=W(()=>{nT(),nz(),nM(),nN(),nD(),nh=(e,r)=>{(e=>{if(!e||1!==e.length)throw Error("Softmax op requires 1 input.")})(e.inputs),((e,r)=>{let i=e.inputs[0],a=i.dims,n=e6.size(a),s=a.length,o=e6.normalizeAxis(r.axis,s),u=o<a.length-1,l,d=[];u?((d=Array.from({length:s},(e,r)=>r))[o]=s-1,d[s-1]=o,l=e.compute(tL(i,d),{inputs:[i],outputs:[-1]})[0]):l=i;let p=l.dims,c=p[s-1],h=n/c,f=tE(c),m=c/f,g=64;1===h&&(g=256);let y=tB("x",l.dataType,l.dims,f),_=tM("result",l.dataType,l.dims,f),b=y.type.value,$="f32"===tS(l.dataType)?`var threadMax = ${b}(-3.4028234663852886e+38f);`:`var threadMax = ${b}(-65504.0h);`,v=e.compute({name:"Softmax",shaderCache:{hint:`${f};${g}`,inputDependencies:["type"]},getRunData:()=>({outputs:[{dims:p,dataType:l.dataType}],dispatchGroup:{x:h},programUniforms:[{type:6,data:m}]}),getShaderSource:e=>`
      ...
      ${e.mainStart(g)}
        ...
        if (lindex == 0) {
          rowSumShared = ${b}(${tA("threadShared[0]",f)});
        }
        workgroupBarrier();
    ...
    }`}})(e.inputs),{inputs:[0]})}}),sS=W(()=>{nT(),nz(),nD(),ny=e=>{e.compute((e=>{let r=e[1].dims,i=e[2].dims,a=e[0].dims,n=e[1].dataType,s=!(e6.areEqual(r,i)&&e6.areEqual(i,a)),o=r,u=e6.size(r);if(s){let e=e4.calcShape(e4.calcShape(r,i,!1),a,!1);if(!e)throw Error("Can't perform where op on the given tensors");o=e,u=e6.size(o)}let l=Math.ceil(u/4);return{name:"Where",shaderCache:{inputDependencies:["rank","rank","rank"]},getShaderSource:r=>((e,r,i,a,n)=>{let s=tM("output_data",n,i.length,4),o=tB("a_data",r[1].dataType,r[1].dims.length,4),u=tB("b_data",r[2].dataType,r[2].dims.length,4),l=tB("c_data",r[0].dataType,r[0].dims.length,4),d,p=(e,r,i)=>`select(${r}, ${e}, ${i})`;if(a){let e=(e,r,i="")=>{let a=`a_data[index_a${r}][component_a${r}]`,n=`b_data[index_b${r}][component_b${r}]`,d=`bool(c_data[index_c${r}] & (0xffu << (component_c${r} * 8)))`;return`
